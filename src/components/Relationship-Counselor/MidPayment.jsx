    ...
    <div id="pricing" className="flex flex-col items-center p-4">
      ...
      <div className="flex flex-col gap-8 p-10 md:flex-row">
        <PlanCard
          ...
          features={['Unlimited Voice & Text Messages', 'Customized to your case', 'No automatic charges', '7 days access']}
        ...
        <PlanCard
          ...
          features={['Unlimited Voice & Text Messages', 'Customized to your case', 'No automatic charges', '30 days access']}
