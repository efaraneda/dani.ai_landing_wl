      ...
      <div className="hover:border border-1 bg-slate-100 rounded-lg md:h-[40vh] px-3 py-3 sm:mb-4">
        ...
        <div className="flex sm:ml-2 md:grid-cols-2 md:gap-6 sm:gap-4 sm:mb-10">
          <div className="text-left">
            ...
            <a className="text-sm">One of the primary components in Mia's architecture, are Large Language Models based in GPT technology. <a rel='nofollow' href="https://openai.com/research/overview" target="_blank" className="underline">Read more here.</a></a>
          </div>
