  ...
  return (
    ...
    <div className="text-white h-[50vh] sm:h-[90vh] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-4 w-full py-14 bg-navy">
      ...
      <div className="sm:-mb-56 flex flex-col items-center justify-left">
        ...
        Theragen es un laboratorio especializado en el desarrollo de sistemas autónomos capaces de emular de manera creíble el comportamiento humano en aplicaciones relacionadas con la psicoterapia.        </p>
      </div>
      ...
      <div className="sm:-mb-60 sm:px-14 sm:mt-10 flex sm:flex-row flex-col items-center justify-left">
          <div className="flex items-center">
              <div >
