...
<section className='mt-28 md:mt-36 flex flex-col items-center'>
  <div className='bg-white w-full md:w-[70%] sm:w-[74%]'>
    <h2 id="funciona" className='mb-2 -mt-12 text-3xl font-bold text-center text-oxford'>
      ¿Cómo funciona?
    </h2>
    <h4 className='relative mb-8 text-l text-center text-gray-500 py-4'>
      Fácil. Envía un mensaje de WhatsApp al <b>+56 (9) 8587 7944</b> en formato texto o audio, saluda 👋 y comienza la terapia.
    </h4>
  </div>
  {/* div color navy */}
  ...
  bg-navy md:rounded-lg sm:w-full sm:h-auto'>
          ...
          <div className='max-h-[400px] sm:max-w-[80%] sm:mt-24 sm:-mb-8'>
              ...
              items-center transform translate-x-4 -translate-y-28 md:ml-3 md:w-[80%] md:mt-36 sm:text-lg'>Nuestro Agente Terapeuta<a className='font-bold'> recordará lo que compartas</a> en WhatsApp y sea relevante para la terapia, como tu nombre, edad, síntomas, etc.   
              </div>
          </div>
        ...
        <div><div className='sm:mt-32 sm:text-center  sm:ml-8 text-white text-sm font-light  md:mt-14   
              items-center transform translate-x-4 -translate-y-28 md:ml-3 md:w-[80%] md:mt-36 sm:text-lg'>La terapia se divide en <a className='font-bold'>7 etapas</a>, comenzando en la introducción y finalizando en el <a className='font-bold'>establecimiento de metas</a>. En la etapa 6, Dani generará un documento con la ficha de tu caso. </div></div></div>
  </div>
{/* div color navy 2 - version small devices */}
  ...
  bg-navy md:rounded-lg sm:w-full sm:h-[auto]'>
        ...
        <div><div className='sm:mt-32 sm:text-center sm:ml-8 text-white text-sm font-light  md:mt-14   
              items-center transform translate-x-4 -translate-y-28 md:ml-3 md:w-[80%] md:mt-36 sm:text-lg'>La versión actual es de <a className='font-bold'>uso gratuito</a>. Nuestro objetivo es desarrollar Inteligencia Artificial útil y barata para todos.  </div></div></div>
  </div>
  ...
  rounded-lg sm:w-full sm:h-[300vh]'>
          <div>
              ...
              items-center transform translate-x-4 -translate-y-28 ml-3 w-[80%] md:mt-36'> Lo que compartas es privado. Siempre puedes ejercer tu "Derecho a ser olvidado" (<a href="https://gdpr.eu/right-to-be-forgotten/" target="_blank" rel='nofollow'>leer más aquí</a>), y solicitar que se elimine toda la información que has compartido con Theragen.</div>
          </div>
          <div>
              <div className='sm:mt-12 sm:ml-4 md:mt-14 flex justify-center items-center transform translate-x-1/2 -translate-y-1/2 rounded-full w-[56px] h-[56px] bg-lavanda'>
                <AiFillHeart className='text-4xl text-crayola'/>
