        ...
        <div className='md:col-span-5 flex items-center justify-center p-8'> {/*Información CTA*/}
          <div>
            ...
            <div className='xl:flex items-center gap-4 py-2'>
                <a href="https://wa.me/message/UEPODIF6XTSYK1" target="_blank" rel='nofollow' className="bg-crayola hover:shadow-xl text-white sm:font-bold py-2 px-6 rounded-xl text-xl hover:bg-bizantino">Evalúate</a>
