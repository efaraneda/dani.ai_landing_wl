...
const Ideal = () => {
    ...
    return (
<div className="bg-white flex flex-col items-center sm:h-600 py-28 sm:py-0">
<div className="sm:h-20"></div>
<h2 className="flex flex-col items-center justify-center sm:text-center text-3xl font-bold text-oxford mb-20 sm:max-w-xs h-16">
...
{/* Image */}
  ...
  <div className="md:hidden absolute top-1/2 -translate-y-1/2 left-1/5 
    ...
    <div className="flex justify-center md:space-x-4 sm:flex-col sm:py-16 sm:space-y-2 ">
      <div className="hover:bg-primary hover:text-white shadow-xl rounded-lg w-52 h-16 sm:w-18 sm:h-18  rounded-md flex flex-col justify-center items-center relative">
