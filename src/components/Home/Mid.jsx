...
const Mid = () => {
  ...
  return (
    <div className="bg-white flex flex-col items-center">
      ...
      <h2 id="acceso" className="my-20 flex flex-col items-center justify-center sm:text-center text-3xl font-bold text-oxford mb-20 sm:max-w-xs h-16">
        Estás a un paso de acceder
      </h2>
      
      <form onSubmit={handleSubmit}  className="my-15 md:w-2/4 lg:w-1/2 bg-lavanda p-10 rounded-lg shadow-lg ">
        <br />
        <div className="mb-6">
...
¿Qué te trajo aquí y con qué te gustaría que te puedan ayudar <3?"
          ...
          <button
            type="submit"
            className="w-full font-bold hover:shadow-xl bg-crayola hover:bg-bizantino text-white py-2 px-6 rounded-xl text-xl transition duration-200"
