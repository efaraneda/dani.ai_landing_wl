const Links = () => {
  return (
    <div className="mt-16 text-white min-auto sm:min-h-[90vh] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-4 w-full py-14 bg-navy">
  ...
  <div className="sm:col-span-1 sm:mb-4 md:ml-28 sm:px-2">
    ...
    <div className="flex flex-col">
      ...
      <a href="https://theragen.ai" className="py-2 md:h-10 md:w-auto hover:text-white flex items-center text-gray-300">Más información</a>
