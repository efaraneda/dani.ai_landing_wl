    ...
    return (
      <section className="font-sans bg-[#791E3F] h-[70vh] w-full "  >
            ...
            <div className="sm:hidden flex flex-col grid grid-cols-6 h-[66vh]" style={{ gridTemplateColumns: '15% 5% 15% 15% 35% 15%' }} >
                ...
                <div className="mt-20 text-center md:text-2xl font-semibold sm:text-xl text-white">Un Colegio Sano, Previene.<br/>
Analítica para Convivencia Escolar.</div>
                <div className=""></div>
            </div>
            <div className="sm:hidden bg-black grid grid-cols-5 h-[4vh]" style={{ gridTemplateColumns: '15% 20% 30% 20% 15%' }}>
                <div className=""></div>
                <div className="flex items-center text-center text-gray-400">2024 Theragen Labs, LLC</div>
                <div className=""></div>
                <div className=""></div>
                <div className=""></div>
