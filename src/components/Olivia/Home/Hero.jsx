...
const Hero = () => {
      ...
      <div className="bg-white mt-28"  ></div>
        <div className="grid grid-cols-3 w-full flex flex-col" style={{ gridTemplateColumns: '16% auto 16%' }}>
            ...
            <div className="items-center flex flex-col ">
                ...
                Convivencia Escolar<br className='sm:hidden'/>Guiada por Datos</h1>
                <h2 className='text-center md:text-xl  sm:text-3xl text-gray-500 mt-10 sm:text-lg sm:w-[135%]'>
               Sólo se puede mejorar lo que se mide. Comienza a medir en minutos, <br className='sm:hidden'/>monitorea el progreso objetivamente </h2>
                ...
                <div className="items-center justify-center  md:flex  gap-4 mt-4">
                    ...
                    <div className='sm:hidden relative flex'>
                        ...
                        >
                        Cuestionarios Smart Diseñados para Estudiantes - Ver Demo
                        </Link>        
                        <span className='text-gray-400 text-sm text-left flex items-start justify-start mt-2 -mb-4 italic'>No más respuestas vagas. Mira cómo capturamos datos de calidad.</span>
                    ...
                    <div className='md:hidden relative flex '>
                        ...
                        <span className='text-gray-400 text-sm text-left flex items-start justify-start mt-2 -mb-4 italic ml-3'>No más respuestas vagas. Mira cómo capturamos datos de calidad.</span>
    ...
    <div className='flex items-center flex-col'>
        ...
        <div className='font-bold text-lg mt-2'>Elige la Herramienta</div>
    </div>
    <div className='flex items-center flex-col mt-6 md:mt-0 mx-6'>
        <PiNumberCircleTwo className='text-greenb2b w-auto h-[30px]' />
        <div className='font-bold text-lg mt-2'>Obtén el Análisis</div>
    </div>
    <div className='flex items-center flex-col mt-6 md:mt-0 mx-4'>
        <PiNumberCircleThree className='text-greenb2b w-auto h-[30px]' />
        <div className='font-bold text-lg mt-2 sm:mb-16'>Toma Acción</div>
    </div>
</div>
