...
<section className=' md:mt-28 sm:py-14 sm:mb-4 sm:bg-navy md:mt-36 flex flex-col items-center'>
  ...
  bg-navy md:rounded-lg sm:w-full'>
          ...
          <div className='max-h-[400px] sm:max-w-[82%] sm:mt-24 sm:-mb-8'>
              ...
              items-center transform translate-x-4 -translate-y-28 md:ml-3 md:w-[80%] md:mt-36 sm:text-lg'>Your conversations are private, secure, and anonymous. We treat all user data as Protected Health Information (PHI) and fully comply with HIPAA regulations to ensure your information is protected.
          ...
          <div className='max-h-[400px] sm:max-w-[80%] sm:-mb-6'>
              ...
              items-center transform translate-x-4 -translate-y-28 md:ml-3 md:w-[80%] md:mt-36 sm:text-lg'>We employ some of the most sophisticated AI models available to guarantee the highest possible accuracy in our results. Before introducing our product to the market, we carried out extensive testing.</div></div></div>
          <div className='max-h-[400px] sm:max-w-[80%] sm:-mb-6'>
            <div className='sm:mt-16 sm:mx-auto md:mt-14 flex justify-center items-center transform translate-x-1/2 -translate-y-1/2 rounded-full w-[56px] h-[56px] bg-lavanda'>
        ...
        <div><div className='sm:mt-32 sm:text-justify  sm:ml-8 text-white text-sm font-light  md:mt-14   
              items-center transform translate-x-4 -translate-y-28 md:ml-3 md:w-[80%] md:mt-36 sm:text-lg'>Our evaluation draws on the methods of cognitive behavioral therapy (CBT), widely regarded as the "gold standard" in contemporary psychotherapy. Its effectiveness is well-documented across numerous studies.
              </div></div></div>
  </div>
{/* div color navy 2 - version small devices */}
  ...
  bg-navy md:rounded-lg sm:w-full sm:h-[auto]'>
          <div className='max-h-[400px] sm:max-w-[80%] sm:-mb-6'>
              ...
              items-center transform translate-x-4 -translate-y-28 md:ml-3 md:w-[80%] md:mt-36 sm:text-lg'> Take the assessment whenever it suits you. Feel free to pause and resume at your convenience. All you need is a device with WhatsApp and an internet connection.   
              </div>
          </div>
          <div className='max-h-[400px] sm:max-w-[80%] sm:-mb-6'>
              <div className='sm:mt-16 sm:mx-auto md:mt-14 flex justify-center items-center transform translate-x-1/2 -translate-y-1/2 rounded-full w-[56px] h-[56px] bg-lavanda'>
        ...
        <div><div className='sm:mt-32 text-justify sm:ml-8 text-white text-sm font-light  md:mt-14   
              items-center transform translate-x-4 -translate-y-28 md:ml-3 md:w-[80%] md:mt-36 sm:text-lg'>Chat as you would with a friend, responding to straightforward questions in everyday language. There's no need for psychological jargon or extensive personal disclosures to complete the assessment.</div></div></div>
  </div>
