...
const Links = () => {
  ...
  <div className=" md:ml-12 sm:col-span-1 sm:mb-4">
    ...
    <p className="sm:mt-0 px-4 sm:px-2 py-4 sm:py-0 text-gray-300">
      Engineering the Future of Psychotherapy.
    </p>
  </div>
  ...
  <div className="sm:col-span-1 sm:mb-4 md:ml-28 sm:px-2">
    ...
    <div className="flex flex-col">
      ...
      <Link
        ...
        <a href="https://www.trustpilot.com/review/theragen.ai" target="_blank" className="py-2 hover:text-white text-gray-300" rel='nofollow'>Your opinion matters</a>
    </div>
  </div>
