  ...
  return (
    <div>
      ...
      <div className="max-w-[70%]">
        <h1 className="flex flex-col items-left text-3xl font-bold text-oxford mb-10 sm:max-w-xs h-16">
        ...
        <p className="py-8">
          ...
          <h2 className="flex flex-col items-left justify-left  text-3xl
          font-bold text-oxford mb-10 sm:max-w-xs h-16 py-20">
          ...
          <h2 className="flex flex-col items-left justify-left  text-3xl
          font-bold text-oxford mb-10 sm:max-w-xs h-16 mt-20">Cambios en esta política de privacidad</h2>
          ...
          Si tienes preguntas o comentarios sobre esta política de privacidad o cómo procesamos tus datos personales, contáctanos a través de contacto@theragen.ai.
          </p>
        </p>
      </div>
      </div>
